...
const sv: Record<TTranslationKeys, string> = {
    ...
    number: 'nummer',
    'add phone': 'la till telefon nummer',
    'add another phone': 'la till annan telefon nummer',
    ...
    // Emails
    'add email': 'la till e-post',
    'add another email': 'la till annan e-post',
    email: 'e-post',
    ...
    // Attributes
    'add another attribute': 'la till ett annat attribut',
    'add attribute': 'la till en attribut',
    text: 'text',
    value: 'värde',
    // Errors
