...
export const enSingle = {
    ...
    'successfully created account settings': 'successfully created account settings',
    'successfully updated account settings': 'successfully updated account settings',
    'could not create account settings': 'could not create account settings',
    'could not update account settings': 'could not update account settings',
